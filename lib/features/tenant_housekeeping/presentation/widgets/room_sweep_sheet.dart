...
class RoomSweepSheet extends StatefulWidget {
  final String roomNumber;
  final String pgName;
  final DateTime? initialDate;
  final String? initialSlot;

  const RoomSweepSheet({
    super.key,
    this.roomNumber = '104',
  ...
  @override
  State<RoomSweepSheet> createState() => _RoomSweepSheetState();
}

class _RoomSweepSheetState extends State<RoomSweepSheet> {
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              'Are you sure you want to schedule room cleaning for Room ${widget.roomNumber}?',
              style: GoogleFonts.outfit(
                fontSize: 13,
  ...
  /// State 1: Calendar and Time Slot Selection View
  Widget _buildSelectionView() {
    return Column(
      ...
      children: [
        ...
        // Full Date Selected Display Card
        Container(
          width: double.infinity,
          padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 12),
          decoration: BoxDecoration(
        ...
        // Primary CTA Button (Triggers Confirmation Dialog)
        SizedBox(
          width: double.infinity,
          height: 48,
          child: ElevatedButton(
            ...
            child: Text(
              'Confirm Sweep for ${_formatShortDate(_selectedDate)}',
              style: GoogleFonts.outfit(
                fontSize: 15,
                fontWeight: FontWeight.w600,
              ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  const Icon(Icons.calendar_today_rounded, size: 16, color: AppColors.greenDark),
                  const SizedBox(width: 10),
                  Expanded(
                    child: Text(
                      _formatFullDate(_selectedDate),
              ...
              Row(
                children: [
                  const Icon(Icons.schedule_rounded, size: 16, color: AppColors.greenDark),
                  const SizedBox(width: 10),
                  Expanded(
                    child: Text(
                      _selectedSlot,
              ...
              Row(
                children: [
                  const Icon(Icons.door_front_door_outlined, size: 16, color: AppColors.greenDark),
                  const SizedBox(width: 10),
                  Expanded(
                    child: Text(
                      'Room ${widget.roomNumber} • ${widget.pgName}',
